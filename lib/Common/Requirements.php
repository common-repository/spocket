...
class Requirements
{
    ...
    public static function checkCurl()
    {
        if (!in_array('curl', get_loaded_extensions())) {
            ...
            'pass'   => false,
            'reason' => __(
                'PHP cURL seems to be disabled or not installed on your server.',
                'spocket'
            ),
    ...
    public static function getStoreNameRequirementsStatus()
    {
        ...
        if (get_option('blogname') === '') {
            ...
            'solution' => __(
                'Please set a name for your store. <br> You can set one '.
                'in <b>Settings > General > Site Title<b>',
                'spocket'
            ),
            );
        }
    ...
    public static function getPermalinksRequirementsStatus()
    {
        if (get_option('permalink_structure', '') === '') {
            ...
            'solution' => __(
                'Set permalinks to anything other than "Plain" '.
                'in <b>Settings > Permalinks</b>',
                'spocket'
            ),
            );
        }
